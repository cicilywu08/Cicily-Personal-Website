    ...
    <div>
      ...
      >
        <div className="relative max-w-3xl mx-auto px-6 pt-16 pb-12">
          ...
          {project.imageUrl && (
            <div className="rounded-2xl overflow-hidden mb-8 shadow-md aspect-video flex items-center justify-center bg-gradient-to-br from-amber-200 via-orange-200 to-rose-200">
